...
package com.oldyang.afw.widget.pulltorefresh;
...
import com.oldyang.afw.widget.pulltorefresh.internal.FlipLoadingLayout;
import com.oldyang.afw.widget.pulltorefresh.internal.LoadingLayout;
import com.oldyang.afw.widget.pulltorefresh.internal.RotateLoadingLayout;
import com.oldyang.afw.widget.pulltorefresh.internal.Utils;
import com.oldyang.afw.widget.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T>
{
    ...
    //add end fields
    private boolean didReachTheEnd;
    ...
    public boolean isDidReachTheEnd()
    {
        return didReachTheEnd;
    }

    public void setDidReachTheEnd(boolean didReachTheEnd)
    {
        this.didReachTheEnd = didReachTheEnd;
        {
            setMode(didReachTheEnd ? Mode.PULL_FROM_START : Mode.BOTH);
        }
    }
    ...
    private void addRefreshableView(Context context , T refreshableView)
    {
        ...
        addViewInternal(mRefreshableViewWrapper, new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT, android.view.ViewGroup.LayoutParams.MATCH_PARENT));
    }
    ...
    private void callRefreshListener()
    {
        ...
        else if (null != mOnRefreshListener2)
        {
            ...
            else if (mCurrentMode == Mode.PULL_FROM_END && !didReachTheEnd)
            {
    ...
    private LinearLayout.LayoutParams getLoadingLayoutLayoutParams()
    {
        ...
        {
            case HORIZONTAL:
                return new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT, android.view.ViewGroup.LayoutParams.MATCH_PARENT);
            case VERTICAL:
            default:
                return new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
        }
    }
